...
// ====================================================================
const Button = ({ children, className = "", variant = "default", type = "button", onClick, disabled }: any) => (
...
const Input = ({ id, name, value, onChange, placeholder, maxLength, required, type = "text", className = "" }: any) => (
...
// Line 18:
const Textarea = ({ id, name, value, onChange, placeholder, className = "" }: any) => (
  // Line 19:
...
const CardTitle = ({ children }: any) => <h3 className="text-xl font-semibold leading-none tracking-tight text-gray-800">{children}</h3>;
const CardDescription = ({ children }: any) => <p className="text-sm text-gray-500">{children}</p>;
const CardContent = ({ children, className = "" }: any) => <div className={`p-6 pt-0 ${className}`}>{children}</div>;
const CardFooter = ({ children, className = "" }: any) => <div className={`flex items-center p-6 pt-0 border-t bg-gray-50/50 rounded-b-xl ${className}`}>{children}</div>;
const Link = ({ href, target, children, className = "" }: any) => <a href={href} target={target} className={`text-blue-600 hover:text-blue-700 ${className}`}>{children}</a>;
...
const ExternalLink = (props: any) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 3h6v6" /><path d="M10 14L21 3" /><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6" /></svg>;
...
const MapPin = (props: any) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg>;
...
const Utensils = (props: any) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 2v22" /><path d="M12 2v22" /><path d="M21 2v22" /></svg>;
const Coffee = (props: any) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 2c-3.3 0-6 2.7-6 6h16c0-3.3-2.7-6-6-6zm-6 6v10c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V8h-12z" /></svg>;
const Shirt = (props: any) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20.5 4.5l-2.5 7-2.5-7H8.5l-2.5 7-2.5-7" /><path d="M12 4v20" /></svg>;
...
const Select = ({ id, name, value, onChange, children, className = "" }: any) => (
  <select id={id} name={name} value={value} onChange={onChange} className={`flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:outline-none disabled:opacity-50 ${className}`}>
    {children}
  </select>
);
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    {categories.filter(c => c.name !== "Semua").map((category) => (
